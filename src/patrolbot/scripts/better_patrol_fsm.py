...
if __name__ == '__main__':
	...
	with patrol:
		...
		for i,w in enumerate(waypoints):
			# Set the fields of the goal_pose message
			...
			goal_pose.target_pose.pose.orientation.x = w[2][3]

			# Instead of creating the states for each waypoint ourselves, use SimpleActionState to do so
