...
if("TRUE" STREQUAL "TRUE")
  set(patrolbot_SOURCE_PREFIX /home/kaiodt/kaio_ros_ws/src/patrolbot)
  set(patrolbot_DEVEL_PREFIX /home/kaiodt/kaio_ros_ws/devel)
  ...
  set(patrolbot_INSTALL_PREFIX /home/kaiodt/kaio_ros_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'patrolbot' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'kaiodt <kaiodt@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'patrolbot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kaiodt/kaio_ros_ws/src/patrolbot/${idir}'.  Ask the maintainer 'kaiodt <kaiodt@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${patrolbot_dep}_FOUND)
      find_package(${patrolbot_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${patrolbot_dep} REQUIRED ${depend_list})
  endif()
