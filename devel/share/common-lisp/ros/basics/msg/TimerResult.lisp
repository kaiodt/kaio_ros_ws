...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TimerResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#~%# Part 2: Result, to be sent by the server upon completion~%#~%# How much time we waited~%duration time_elapsed~%#~%# How many updates we provided along the way~%uint32 updates_sent~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TimerResult)))
  "Returns full string definition for message of type 'TimerResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%#~%# Part 2: Result, to be sent by the server upon completion~%#~%# How much time we waited~%duration time_elapsed~%#~%# How many updates we provided along the way~%uint32 updates_sent~%~%~%"))
